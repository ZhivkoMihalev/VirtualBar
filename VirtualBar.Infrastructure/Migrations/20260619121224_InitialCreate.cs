        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Distillery = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BottleComments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BottleComments_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BottleComments_Bottles_BottleId",
                        column: x => x.BottleId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BottleImages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BottleImages_Bottles_BottleId",
                        column: x => x.BottleId,
                        principalTable: "Bottles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BottleLikes", x => new { x.BottleId, x.UserId });
                    table.ForeignKey(
                        name: "FK_BottleLikes_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BottleLikes_Bottles_BottleId",
                        column: x => x.BottleId,
                        principalTable: "Bottles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BottleComments_BottleId",
                table: "BottleComments",
                column: "BottleId");

            migrationBuilder.CreateIndex(
                name: "IX_BottleComments_UserId",
                table: "BottleComments",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_BottleImages_BottleId",
                table: "BottleImages",
                column: "BottleId");

            migrationBuilder.CreateIndex(
                name: "IX_BottleLikes_UserId",
                table: "BottleLikes",
                column: "UserId");
